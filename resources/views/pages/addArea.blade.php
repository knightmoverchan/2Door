    ...
    <div class="row">
      <div class="col-mid-3 col-md-offset-3">
        <div class="panel panel-default">
          <br/><h1>Add Assigned</h1>
          <a href="/viewArea">View Assigned Areas</a>
          @if(count($errors) > 0)
          ...
          {!!Form::open(array('url' => '/addArea' ,'onkeypress'=>'return event.keyCode != 13'))!!}
          <br/>  
            {!! Form::label('Name'); !!}
            {!! Form::text('areaName', '', array('class' => 'form-control', 'placeholder' => 'Area Name')); !!} 
